...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Navigation */}
      <div className="border border-stone-800/90 p-[0.4rem] rounded-lg mb-12 sticky top-4 z-[100] bg-stone-900/80 backdrop-blur-md transition-all duration-300 hover:border-stone-700/90">
        <nav
          ref={navRef}
